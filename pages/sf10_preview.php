        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        <?php 
                        // Get all subjects from database, prioritizing display_order
                        $subjects_query = $conn->query("SELECT id, subject_name, display_order FROM subjects WHERE subject_name != 'General Average' ORDER BY display_order ASC, id ASC");
